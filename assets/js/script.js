	...
	jQuery(document).ready(function($){
		...
		$("body").on('click', '.spria_upload_file', function(event) {
			...
			var custom_uploader = wp.media({
				...
				btnClicked.closest(".spria_metabox_file").find(".custom_upload_file").val(attachment.id);
				btnClicked.closest(".spria_metabox_file").find(".custom_preview_file").attr("href", attachment.url).html(attachment.title).show();
				btnClicked.closest(".spria_metabox_file").find(".spria_remove_file_wrap").show();
			}).open();
			
		});
		$("body").on('click', '.spria_remove_file', function(event) {
			event.preventDefault();
			$(this).closest(".spria_metabox_file").find(".custom_upload_file").val("");
