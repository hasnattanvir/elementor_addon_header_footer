...
if( ! function_exists('handle_theme_change') ){
...
if(!function_exists('notify_admin_to_switch_theme')){
    function notify_admin_to_switch_theme() {
        ?>
        <div class="notice notice-warning is-dismissible cw-active-warning-notice">
...
//==================== Elementor Active notice ==========================
if( ! function_exists('notify_admin_to_activate_elementor') ){
...
//==================== Remove plugin menu when active another theme ==========================
