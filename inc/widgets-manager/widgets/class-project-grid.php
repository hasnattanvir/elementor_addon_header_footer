...
class ProjectGrid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Curlware Project Grid', 'curlware-elements' );
	}
	...
	protected function register_general_content_controls() {
        ...
        $this->add_control(
			'filter',
			[
				'label' => __('Filter', 'curlware-elements-core'),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'General ', 'curlware-elements' ),
			]
		);
	...
	protected function register_heading_typo_content_controls() {	
		...
		$this->start_controls_section(
			'grid_menu_style',
			[
				'label' => esc_html__( 'Menu Style', 'curlware-elements' ),
		...
		$this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'curlware-elements' ),
		...
		$this->add_control(
            'menu_active_color',
            [
                'label' => esc_html__( 'Menu Active Color', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Menu Background Color', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Menu Background Before Color', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->start_controls_section(
			'section_icon_style',
			[
				'label' => esc_html__( 'Icon Style', 'curlware-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
        ...
        $this->add_control(
            'icon_section_bg',
            [
                'label' => esc_html__( 'Icon Section Background', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
			'section_title_style',
			[
				'label' => esc_html__( 'Title Style', 'curlware-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
         ...
         $this->add_control(
            'title_color',
            [
                'label' => esc_html__( 'Title Color', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
			'section_cat_style',
			[
				'label' => esc_html__( 'Category Style', 'curlware-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
            'category_color',
            [
                'label' => esc_html__( 'Category Color', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Global Style', 'curlware-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
            'project_item_bg',
            [
                'label' => esc_html__( 'Project Overlay', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Project Border Radious', 'curlware-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Project Background', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'image_overlay',
            [
                'label' => esc_html__( 'Image Hover Overlay', 'curlware-elements' ),
                'type' => Controls_Manager::COLOR,
                'condition' => [
        ...
        $this->add_responsive_control(
			'text_align',
			[
				'label'              => __( 'Alignment', 'curlware-elements' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => [
					'left'    => [
						'title' => __( 'Left', 'curlware-elements' ),
						'icon'  => 'fa fa-align-left',
					],
					'center'  => [
						'title' => __( 'Center', 'curlware-elements' ),
						'icon'  => 'fa fa-align-center',
					],
					'right'   => [
						'title' => __( 'Right', 'curlware-elements' ),
						'icon'  => 'fa fa-align-right',
					],
					'justify' => [
						'title' => __( 'Justify', 'curlware-elements' ),
	...
	protected function render() {
        ...
        <div class="sc-project-filter gridFilter text-center mb-70 md-mb-50">
				<button class="active" data-filter="*"><?php esc_html_e('Show All', 'curlware-elements'); ?></button>
				<?php
