...
class SC_PriceTable extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Curlware Price Table', 'curlware-header-footer-elementor' );
	}
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .rs-pricing-table-feature-text' => 'color: {{VALUE}}'
                ],
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}} .rs-pricing-table-features-list li i:before' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
