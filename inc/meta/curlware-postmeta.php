...
require_once curlwareelements_DIR . '/inc/meta/curlware-postmeta-fields.php';

if( !class_exists( 'curlware_Postmeta' ) ){

	class curlware_Postmeta {
		protected static $instance = null;
		public  $version          = curlwareelements_VER;
		private $fields_obj       = null;
		public  $base_url         = null;
		private $metaboxes        = array();
		private $metabox_fields   = array();
		private $nonce_action     = 'curlware_metabox_nonce';
		private $nonce_field      = 'curlware_metabox_nonce_secret';
		private function __construct() {
			$this->fields_obj = new curlware_Postmeta_Fields();
			$this->base_url   = curlwareelements_URL;
		...
		public function load_styles_and_scripts(){
			...
			wp_enqueue_style( 'meta-style', $this->base_url . 'assets/css/meta-style.css', array(), $this->version );
		...
		public function add_meta_box( $id, $title, $post_types, $callback = '', $context = '', $priority = '', $fields = '' ) {
			...
			$fields = apply_filters( 'curlware_postmeta_field_' . $id, $fields );
			$metaboxes = array(
				'title'         => $title,
				'callback'      => $callback,
			...
			$this->metaboxes[$id] = apply_filters( 'curlware_metabox_' . $id, $metaboxes );
