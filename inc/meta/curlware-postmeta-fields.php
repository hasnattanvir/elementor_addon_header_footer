...
if( !class_exists( 'curlware_Postmeta_Fields' ) ){
	class curlware_Postmeta_Fields {
		...
		public function image( $key, $field, $default, $class ){
			...
			<div class="curlware_metabox_image">
				...
				<input class="curlware_upload_image upload_button_'. esc_attr( $key ) .' button-primary" type="button" value="' . esc_attr__( 'Choose Image', 'rt-framework' ). '" />
		...
		public function file( $key, $field, $default, $class ){
			...
			echo '
			<div class="curlware_metabox_file">
				<input name="'. esc_attr( $key ) .'" type="hidden" class="custom_upload_file" value="'. esc_attr( $default ) .'" />
				<input class="curlware_upload_file upload_button_'. esc_attr( $key ) .' button-primary" type="button" value="' . esc_attr__( 'Choose File', 'rt-framework' ). '" />
				<div class="curlware_remove_file_wrap" style="'. esc_attr( $disstyle ) .'"><a href="#" class="curlware_remove_file button" >' . esc_html__( 'Remove File', 'rt-framework' ). '</a></div>
