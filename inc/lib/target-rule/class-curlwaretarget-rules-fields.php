 ...
 * Meta Boxes setup
 */
class curlwareelements_Target_Rules_Fields {
	/**
	 * Instance
	 *
	 * @since  1.0.0
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_socoders_elements_get_posts_by_query', array( $this, 'socoders_elements_get_posts_by_query' ) );
	}
	 ...
	 * @since  1.0.0
	 */
	function socoders_elements_get_posts_by_query() {

		check_ajax_referer( 'sce-get-posts-by-query', 'nonce' );
	 ...
	 * This is only run from socoders_elements_get_posts_by_query()
	 *
 ...
 */
curlwareelements_Target_Rules_Fields::get_instance();
