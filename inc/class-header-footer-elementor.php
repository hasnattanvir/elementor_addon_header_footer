...
class Header_Footer_Elementor {
	...
	public function includes() {
		require_once curlwareelements_DIR . 'admin/class-curlwareelements-admin.php';
		require_once curlwareelements_DIR . 'admin/class-curlwareelements-settings.php';
		require_once curlwareelements_DIR . 'admin/curlware-header-footer-setting.php';

		require_once curlwareelements_DIR . 'inc/curlwareelements-functions.php';

		// Load Elementor Canvas Compatibility.
		require_once curlwareelements_DIR . 'inc/class-sce-elementor-canvas-compat.php';

		// Load Target rules.
		require_once curlwareelements_DIR . 'inc/lib/target-rule/class-curlwaretarget-rules-fields.php';

		// Load the widgets.
		require curlwareelements_DIR . 'inc/widgets-manager/class-widgets-loader.php';
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'sce-style', curlwareelements_URL . 'assets/css/header-footer-elementor.css', [], curlwareelements_VER );
	...
	public function enqueue_admin_scripts() {
		...
		if ( ( 'elementor-hf' == $screen->id && ( 'post.php' == $pagenow || 'post-new.php' == $pagenow ) ) || ( 'edit.php' == $pagenow && 'edit-elementor-hf' == $screen->id ) ) {
			...
			wp_enqueue_style( 'sce-admin-style', curlwareelements_URL . 'admin/assets/css/ehf-admin.css', [], curlwareelements_VER );
			wp_enqueue_script( 'sce-admin-script', curlwareelements_URL . 'admin/assets/js/ehf-admin.js', [ 'jquery', 'updates' ], curlwareelements_VER, true );
		...
		if ( ! current_theme_supports( 'curlware-header-footer-elementor' ) ) {
			...
			if ( '1' === $socoders_elements_compatibility_option ) {
				if ( ! class_exists( 'socoders_elements_Default_Compat' ) ) {
					require_once curlwareelements_DIR . 'themes/default/class-sce-default-compat.php';
				}
			} elseif ( '2' === $socoders_elements_compatibility_option ) {
				require curlwareelements_DIR . 'themes/default/class-global-theme-compatibility.php';
			}
		}
	}
	...
	public static function get_template_id( $type ) {
		...
		$socoders_elements_templates = curlwareelements_Target_Rules_Fields::get_instance()->get_posts_by_conditions( 'elementor-hf', $option );
